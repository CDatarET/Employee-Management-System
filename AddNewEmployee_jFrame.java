...
public class AddNewEmployee_jFrame extends javax.swing.JFrame {
    ...
    private void addTheNewEmployee(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addTheNewEmployee
        ...
        if (jRadioButton2.isSelected()) {
            ...
            double hWage = Double.parseDouble(jTextField5.getText());
            
            int hPerWeek = Integer.parseInt(jTextField6.getText());
                    
            int wPerYear = Integer.parseInt(jTextField7.getText());
            
            // Instantiate an PTE with the info for that employee
            PTE thePTE = new PTE(theEmpNum, theFirstName, theLastName,0,0,0.25, hWage, hPerWeek, wPerYear);
            
            // Add that employee to the hash table
            mainHT.addEmployee(thePTE);
            
            System.out.println("added new part time employee!");
        }
